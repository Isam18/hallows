...
export interface TriggerConfig {
  id: string;
  type: 'bench' | 'transition' | 'bossGate' | 'gate' | 'decoration' | 'chain' | 'shop' | 'endDoor' | 'greenwayDoor' | 'skeleton' | 'lavaDoor' | 'verdantDoor' | 'bossExitTransition' | 'verdainaDoor' | 'fakeBench' | 'lockedVerdainaDoor' | 'waveArena' | 'campfire' | 'crimsonKeyDoor' | 'hunterBossArena' | 'fungusDoor';
  x: number;
  y: number;
  width: number;
  height: number;
