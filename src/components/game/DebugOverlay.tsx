    ...
    <div className="fixed top-4 left-4 bg-card/90 backdrop-blur-sm border border-border rounded-lg p-4 font-mono text-sm z-50 min-w-[280px] shadow-lg max-h-[90vh] overflow-y-auto">
      ...
      <div className="mt-3 pt-2 border-t border-border">
        ...
        <div className="grid grid-cols-2 gap-1.5">
          ...
          <button onClick={() => handleTeleport('shroomialLands')} className="px-2 py-1 text-xs bg-yellow-600/20 hover:bg-yellow-600/40 border border-yellow-600/30 rounded transition-colors">🍄 Shroomial Lands</button>
          <button onClick={() => handleTeleport('freezingPlains')} className="px-2 py-1 text-xs bg-cyan-600/20 hover:bg-cyan-600/40 border border-cyan-600/30 rounded transition-colors">❄️ Freezing Plains</button>
          ...
          <button onClick={() => handleTeleport('freezingPlainsRoom6')} className="px-2 py-1 text-xs bg-cyan-600/20 hover:bg-cyan-600/40 border border-cyan-600/30 rounded transition-colors">❄️ Crystalline Vault</button>
          <button onClick={() => handleTeleport('freezingPlainsRoom7')} className="px-2 py-1 text-xs bg-cyan-600/20 hover:bg-cyan-600/40 border border-cyan-600/30 rounded transition-colors">❄️ Gatekeeper's Watch</button>
          <button onClick={() => handleTeleport('freezingPlainsBench')} className="px-2 py-1 text-xs bg-cyan-600/20 hover:bg-cyan-600/40 border border-cyan-600/30 rounded transition-colors">❄️ Frozen Bench</button>
          <button onClick={() => handleTeleport('freezingPlainsRoom8')} className="px-2 py-1 text-xs bg-cyan-600/20 hover:bg-cyan-600/40 border border-cyan-600/30 rounded transition-colors">❄️ Echoing Chasm</button>
          <button onClick={() => handleTeleport('freezingPlainsRoom9')} className="px-2 py-1 text-xs bg-cyan-600/20 hover:bg-cyan-600/40 border border-cyan-600/30 rounded transition-colors">❄️ Shattered Spire</button>
          <button onClick={() => handleTeleport('freezingPlainsRoom10')} className="px-2 py-1 text-xs bg-cyan-600/20 hover:bg-cyan-600/40 border border-cyan-600/30 rounded transition-colors">❄️ Prism Array</button>
          <button onClick={() => handleTeleport('freezingPlainsRoom11')} className="px-2 py-1 text-xs bg-cyan-600/20 hover:bg-cyan-600/40 border border-cyan-600/30 rounded transition-colors">❄️ Graveyard of Giants</button>
          <button onClick={() => handleTeleport('freezingPlainsRoom12')} className="px-2 py-1 text-xs bg-cyan-600/20 hover:bg-cyan-600/40 border border-cyan-600/30 rounded transition-colors">❄️ Frost-Wind Tunnel</button>
          <button onClick={() => handleTeleport('freezingPlainsRoom13')} className="px-2 py-1 text-xs bg-cyan-600/20 hover:bg-cyan-600/40 border border-cyan-600/30 rounded transition-colors">❄️ Vault of Ancients</button>
          <button onClick={() => handleTeleport('freezingPlainsRoom14')} className="px-2 py-1 text-xs bg-cyan-600/20 hover:bg-cyan-600/40 border border-cyan-600/30 rounded transition-colors">❄️ Hollow Passage</button>
          <button onClick={() => handleTeleport('freezingPlainsRoom15')} className="px-2 py-1 text-xs bg-cyan-600/20 hover:bg-cyan-600/40 border border-cyan-600/30 rounded transition-colors">❄️ Titan's Threshold</button>
          <button onClick={() => handleTeleport('freezingPlainsRoom16')} className="px-2 py-1 text-xs bg-cyan-600/20 hover:bg-cyan-600/40 border border-cyan-600/30 rounded transition-colors">❄️ Final Rampart</button>
          <button onClick={() => handleTeleport('glacialTitanArena')} className="px-2 py-1 text-xs bg-cyan-600/20 hover:bg-cyan-600/40 border border-cyan-600/30 rounded transition-colors">🧊 Glacial Titan</button>
