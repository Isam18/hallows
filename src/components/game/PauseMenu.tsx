      ...
      {debugMode && (
        <div className="mt-6 pt-4 border-t border-border/50">
          ...
          <div className="grid grid-cols-2 gap-1.5 max-w-md">
            ...
            <button onClick={() => handleTeleport('medullaRoom2')} className="px-2 py-1 text-xs bg-destructive/20 hover:bg-destructive/40 border border-destructive/30 rounded transition-colors">Room 2: Shaft</button>
            ...
            <button onClick={() => handleTeleport('medullaRoom4')} className="px-2 py-1 text-xs bg-destructive/20 hover:bg-destructive/40 border border-destructive/30 rounded transition-colors">Room 4: Vertebrae</button>
            ...
            <button onClick={() => handleTeleport('medullaRoom6')} className="px-2 py-1 text-xs bg-destructive/20 hover:bg-destructive/40 border border-destructive/30 rounded transition-colors">Room 6: Femur</button>
            ...
            <button onClick={() => handleTeleport('medullaRoom8')} className="px-2 py-1 text-xs bg-accent/20 hover:bg-accent/40 border border-accent/30 rounded transition-colors">Room 8: Skull Tyrant</button>
            <button onClick={() => handleTeleport('medullaRoom31')} className="px-2 py-1 text-xs bg-accent/20 hover:bg-accent/40 border border-accent/30 rounded transition-colors">Room 31: Final Passage</button>
            <button onClick={() => handleTeleport('medullaRoom32')} className="px-2 py-1 text-xs bg-accent/20 hover:bg-accent/40 border border-accent/30 rounded transition-colors">Room 32: Final Boss</button>
            <button onClick={() => handleTeleport('skullRavagerArena')} className="px-2 py-1 text-xs bg-destructive/20 hover:bg-destructive/40 border border-destructive/30 rounded transition-colors font-bold">⚔️ Skull Ravager</button>
